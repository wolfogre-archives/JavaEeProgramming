...
<div style="width:30%;" class="center-block">
	...
	<form action="CheckOut.action" >
		...
		<div class="form-group">
			<label>商品代码</label>
			<input type="text" name="productCode" class="form-control" value="<%=request.getAttribute("productCode")%>" readonly>
		</div>
		<div class="form-group">
			<label >商品名</label>
			<input type="text" name="productName" class="form-control" value="<%=request.getAttribute("productName")%>" readonly>
		</div>
		<div class="form-group">
			<label >商品产自</label>
			<input type="text" name="productSource" class="form-control" value="<%=request.getAttribute("productSource")%>" readonly>
		</div>
		<div class="form-group">
			<label >购买数量</label>
